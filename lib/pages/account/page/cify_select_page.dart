...
import 'package:flutter_demo/pages/account/models/city_entity.dart';
      ...
      body: SafeArea(
        child: AzListView(
          ...
          indexBarOptions: IndexBarOptions(
            ...
            downTextStyle:
                context.isDark ? TextStyles.textSize12 : const TextStyle(fontSize: 12.0, color: Colors.black),
          ),
        ),
      ),
    );
