...
import 'package:flutter_demo/pages/goods/provider/goods_sort_provider.dart';
import 'package:flutter_demo/pages/goods/widgets/goods_sort_menu.dart';
...
import 'package:flutter_demo/widget/popup_window.dart';
...
class _GoodsPageState extends State<GoodsPage> with AutomaticKeepAliveClientMixin, SingleTickerProviderStateMixin {
        ...
        children: <Widget>[
          ...
          SizedBox(
            ...
            child: FlatButton.icon(
                ...
                onPressed: () {
                  NavigatorUtils.push(context, '${GoodsRouter.goodsSearchPage}?isAdd=true&isScan=true', replace: true);
                },
          ...
          SizedBox(
            ...
            child: FlatButton.icon(
                ...
                color: backgroundColor,
                onPressed: () {
                  NavigatorUtils.push(context, '${GoodsRouter.goodsSearchPage}?isAdd=true', replace: true);
                },
                shape: const RoundedRectangleBorder(
