...
class SelecetdImage extends StatefulWidget {
  SelecetdImage({
    Key key,
    this.size = 80,
  }) : super(key: key);
  ...
  @override
  _SelectedImage createState() => _SelectedImage();
}

class _SelectedImage extends State<SelecetdImage> {
  File imageFile;
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                ...
                colorFilter: imageFile == null
                    ? ColorFilter.mode(
                        ThemeUtils.getDarkColor(context, Colours.dark_unselected_item_color), BlendMode.srcIn)
                    : null,
              ),
            ),
          ),
